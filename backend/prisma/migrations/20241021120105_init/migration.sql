...
CREATE TABLE "Admin" (
    ...
    CONSTRAINT "Admin_pkey" PRIMARY KEY ("zid")
);
...
-- AddForeignKey
ALTER TABLE "Admin" ADD CONSTRAINT "Admin_zid_fkey" FOREIGN KEY ("zid") REFERENCES "User"("zid") ON DELETE RESTRICT ON UPDATE CASCADE;
